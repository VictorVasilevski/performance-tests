...
from clients.http.gateway.accounts.schema import OpenDebitAccountResponseSchema
...
class MakePurchaseOperationSequentialTaskSet(GatewayHttpSequentialTaskSet):
    ...
    open_debit_card_account_response: OpenDebitAccountResponseSchema | None = None
