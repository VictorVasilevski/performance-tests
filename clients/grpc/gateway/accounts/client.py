...
class AccountsGatewayGrpcClient(GrpcClient):
    def __init__(self, channel: Channel):
        ...
        self.stub = AccountsGatewayServiceStub(self.channel)
    ...
    def open_debit_account_api(self, request: OpenDebitCardAccountRequest) -> OpenDebitCardAccountResponse:
        return self.stub.OpenDebitCardAccount(request)

    def open_credit_account_api(self, request: OpenCreditCardAccountRequest) -> OpenCreditCardAccountResponse:
    ...
    def open_debit_account(self, user_id: str) -> OpenDebitCardAccountResponse:
        ...
        return self.open_debit_account_api(request)
    ...
    def open_credit_account(self, user_id: str) -> OpenCreditCardAccountResponse:
        ...
        return self.open_credit_account_api(request)
