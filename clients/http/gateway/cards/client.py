...
class CardsGatewayHTTPClient(HttpClient):
    ...
    def issue_virtual_card_api(self, request: IssueVirtualCardRequestSchema) -> Response:
        ...
        """
        return self.post("/api/v1/cards/issue-virtual-card", body=request.model_dump_json(by_alias=True))
    ...
    def issue_physical_card_api(self, request: IssuePhysicalCardRequestSchema) -> Response:
        ...
        :return: Ответ от сервера (объект httpx.Response).
        """
        return self.post("/api/v1/cards/issue-physical-card", body=request.model_dump_json(by_alias=True))
